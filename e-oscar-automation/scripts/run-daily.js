#!/usr/bin/env node
/**
 * Script to run E-Oscar dispute review automation on a daily basis
 */
...
logger.info('E-Oscar dispute review automation scheduler started');
logger.info('Scheduled to run at 9:00 AM every day');
